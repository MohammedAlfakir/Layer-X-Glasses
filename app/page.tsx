  ...
  return (
    <>
      ...
      <video
        ...
        muted
        playsInline
        className="absolute inset-0 w-full h-full object-cover z-0 opacity-80 mix-blend-lighten"
      >
      ...
      <div className="max-w-[1400px] w-full mx-auto flex flex-col md:flex-row justify-between h-full gap-8 md:gap-16 pt-12 md:pt-24 flex-1 relative z-10">
        ...
        <div className="flex flex-col justify-between w-full md:w-1/2 max-w-xl relative">
          <div className="flex flex-col gap-8">
            <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] leading-[1.05] tracking-wide uppercase text-[#cbb592]">
              LAYER-X //
              <br />
              NEURAL
              <br />
            ...
            <p className="font-sans text-[#a28f73] text-[15px] max-w-md leading-[1.8] tracking-wide mt-2">
              Engineered for the LAYER-X glasses, an ultra-lightweight frame for
              users who don&apos;t just view the AR world—they own it. Shift reality.
            </p>
          </div>
          ...
          <div className="mt-16 sm:mt-auto border border-[#2a2a2a] rounded-[2rem] p-8 max-w-[26rem] bg-black relative max-h-min mb-4">
            <h3 className="text-xs font-bold tracking-[0.2em] mb-4 text-[#cbb592] uppercase">
              MS-01: NEURAL CORE
            </h3>
            <p className="font-sans text-[#998668] text-[14px] mb-8 leading-relaxed">
              High-resolution optics and a light
              <br />
              frame for comfort and clarity.
            </p>
            <button className="border border-[#444] text-[#a28f73] rounded-full px-8 py-3 text-xs tracking-wider hover:bg-[#B69D74]/10 transition-colors bg-transparent">
              Add to Cart
            </button>
          </div>
        </div>
        ...
        {/* Right Column */}
        <div className="flex flex-col justify-end w-full md:w-1/2 relative pb-8 md:pb-4 gap-12">
          {/* Middle Right: Technical Specs */}
          <div className="w-full max-w-[28rem] self-end mt-16 md:mt-0 md:-translate-y-12">
            <h3 className="text-[11px] tracking-[0.2em] mb-8 font-bold text-[#cbb592]">
              TECHNICAL SPECS
            </h3>
            <div className="flex flex-col font-sans text-[13px] tracking-wide border-t border-b border-[#222] divide-y divide-[#222]">
