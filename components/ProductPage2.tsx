...
export default function ProductPage2({ onPrev }: ProductPage2Props) {
  return (
    <div
    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] w-full mx-auto flex flex-col md:flex-row justify-between gap-8 md:gap-16 pt-12 md:pt-24">
        ...
        <div className="flex flex-col gap-8 w-full md:w-1/2 max-w-xl">
          ...
          {/* Shop Now button */}
          <button className="flex items-center gap-3 border border-[#444] text-[#cbb592] rounded-full px-7 py-3 text-[11px] tracking-widest hover:bg-[#cbb592]/10 transition-colors bg-transparent self-start">
            <svg
      ...
      {/* Bottom: Giant "BOLD GAZE" text — one line */}
